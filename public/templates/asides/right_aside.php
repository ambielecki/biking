<div class="col-sm-2 hidden-sm hidden-xs">
    <aside id="aside_right">
        <h3>Bike Advocacy</h3>
        <ul>
            <li><a href="http://www.nemba.org/chapters/gbnemba">Greater Boston NEMBA</a></li>
            <li><a href="http://nsnemba.org/">North Shore NEMBA</a></li>
            <li><a href="http://massbike.org/">Mass Bike</a></li>
            <li><a href="http://www.bostonbikes.org/">Boston Bikes</a></li>
        </ul>
        <h3>Bike Clubs</h3>
        <ul>
            <li><a href="http://www.nscyc.org/">North Shore Cyclists</a></li>
            <li><a href="http://crw.org/">Charles River Wheelmen</a></li>
        </ul>
        <h3>Local Bike Shops</h3>
        <ul>
            <li><a href="http://www.jracycles.com/">JRA Cycles - Medford</a></li>
            <li><a href="http://citycycleinc.com/">City Cycle - Stoneham</a></li>
        </ul>
        <h3>Local Parks</h3>
        <ul>
